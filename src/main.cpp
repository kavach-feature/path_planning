  ...
  h.onMessage([&ref_vel, &map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy, &lane](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
                  ...
                  //ref_vel = 29.5; // mph
                    ...
                    if (lane == 0)
                    {
                      if (lane_check(sensor_fusion, car_s, lane +1, prev_size) > 0)
                        {
                             lane = 1;
                             cout<<"Change to the right lane-Entering center lane from fast lane to pass the car"<<endl;
                        }
                    }
                    else if (lane == 2)
                    {
                      ...
                      {
                        lane = 1;
                        cout<<"Change to the left lane- Entering center lane from slowest lane to pass the car"<<endl;
                       }
                    }
                    else 
                    { 
                        ...
                        double right_dist = lane_check(sensor_fusion, car_s, lane+1, prev_size);
                         if (left_dist > right_dist)
                          {
                             lane = 0;
                             cout<<"Change to the fast lane from center lane to pass the car"<<endl;
                          }
                         else if (right_dist > left_dist)
                         {
                            lane = 2;
                            cout<<"Change to the slowest lane from center lane to pass the car"<<endl;
                         }
                    }
                }
              }
    ...
    ptsy[i] = (shift_x*sin(0 - ref_yaw) + shift_y*cos(0 - ref_yaw));
      ...
      vector<double> next_x_vals;
            ...
            //Changed it for the spline Q&A session
